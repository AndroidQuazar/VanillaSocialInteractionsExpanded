...
{
	public class LordJob_Joinable_OutdoorParty : LordJob_Joinable_Gathering
	{
		private int durationTicks;
		public override bool AllowStartNewGatherings => false;

		protected virtual ThoughtDef AttendeeThought => VSIE_DefOf.VSIE_AttendedOutdoorParty;

		protected virtual TaleDef AttendeeTale => TaleDefOf.AttendedParty;

		protected virtual ThoughtDef OrganizerThought => VSIE_DefOf.VSIE_AttendedOutdoorParty;

		protected virtual TaleDef OrganizerTale => TaleDefOf.AttendedParty;

		public int DurationTicks => durationTicks;

		public LordJob_Joinable_OutdoorParty()
		{
		}

		public LordJob_Joinable_OutdoorParty(IntVec3 spot, Pawn organizer, GatheringDef gatheringDef)
			: base(spot, organizer, gatheringDef)
		{
			durationTicks = Rand.RangeInclusive(13000, 17000);
		}
		...
		public override void ExposeData()
		{
			...
			{
				gatheringDef = VSIE_DefOf.VSIE_OutdoorParty;
			}
		}
	}
}
