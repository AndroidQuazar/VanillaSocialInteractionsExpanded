...
{
    public class LordJob_Joinable_BuildingSnowmen : LordJob_Joinable_DoublePawn
    {
        public LordJob_Joinable_BuildingSnowmen()
        {

        }
        public LordJob_Joinable_BuildingSnowmen(Pawn organizer, Pawn companion, IntVec3 spot, GatheringDef gatheringDef, int ticks)
        ...
        protected override void ApplyOutcome(LordToil_Party toil)
        {
            ...
            {
                Thought_Memory thought_Memory = (Thought_Memory)ThoughtMaker.MakeThought(VSIE_DefOf.VSIE_JealouslyMyPartnerBuiltSnowmenWithSomeoneElse);
        ...
        public override void ExposeData()
        {
            ...
            {
                gatheringDef = VSIE_DefOf.VSIE_BuildingSnowmen;
            }
        }
    }
}