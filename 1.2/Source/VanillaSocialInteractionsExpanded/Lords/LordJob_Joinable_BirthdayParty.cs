...
{
	public class LordJob_Joinable_BirthdayParty : LordJob_Joinable_Gathering
	{
		private int durationTicks;

		public override bool AllowStartNewGatherings => false;

		protected virtual ThoughtDef AttendeeThought => VSIE_DefOf.VSIE_AttendedBirthdayParty;

		protected virtual TaleDef AttendeeTale => TaleDefOf.AttendedParty;

		protected virtual ThoughtDef OrganizerThought => VSIE_DefOf.VSIE_HadBirthdayParty;

		protected virtual TaleDef OrganizerTale => TaleDefOf.AttendedParty;

		public int DurationTicks => durationTicks;

		public LordJob_Joinable_BirthdayParty()
		{
		}

		public LordJob_Joinable_BirthdayParty(IntVec3 spot, Pawn organizer, GatheringDef gatheringDef)
		...
		private void ApplyOutcome(LordToil_Party toil)
		{
			...
			if (VSIE_Utils.SocialInteractionsManager.birthdays.ContainsKey(organizer))
            {
				VSIE_Utils.SocialInteractionsManager.birthdays.Remove(organizer);
			};
		}
		...
		public override void ExposeData()
		{
			...
			{
				gatheringDef = VSIE_DefOf.VSIE_BirthdayParty;
			}
		}
	}
}
