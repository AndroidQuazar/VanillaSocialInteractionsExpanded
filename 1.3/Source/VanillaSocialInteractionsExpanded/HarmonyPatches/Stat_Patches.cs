...
namespace VanillaSocialInteractionsExpanded
{
	...
	public static class GetStatValue_Patch
    {
		private static void Postfix(Thing thing, StatDef stat, bool applyPostProcess, ref float __result)
        {
            ...
            else if (VanillaSocialInteractionsExpandedSettings.EnableManyHandsMakeLightWork && stat == StatDefOf.GlobalLearningFactor && thing is Pawn pawn2 && pawn2.mindState != null && VSIE_Utils.workTags.Contains(pawn2.mindState.lastJobTag))
            {
